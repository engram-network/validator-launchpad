...
export const TESTNET_LAUNCHPAD_NAME     = process.env.REACT_APP_TESTNET_LAUNCHPAD_NAME || 'Engram';
...
export const MAINNET_LAUNCHPAD_URL      = 'https://launchpad-mainnet.engram.tech/'
export const TESTNET_LAUNCHPAD_URL      = `https://launchpad-testnet.engram.tech`
export const FAUCET_URL                 = process.env.REACT_APP_FAUCET_URL || 'https://faucet-pow.engram.tech/'
...
export const CHAIN_ID                   = Number(process.env.REACT_APP_CHAIN_ID) || 131;
...
export const ETH_REQUIREMENT            = process.env.REACT_APP_ETH_REQUIREMENT     || 3200;
...
let forkVersion = Buffer.from('10000131', 'hex')
...
export const EJECTION_PRICE             = process.env.REACT_APP_EJECTION_PRICE || 31;
